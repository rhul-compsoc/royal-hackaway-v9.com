...
const Footer = (): ReactElement => {
  return (
    <footer className="relative bg-white lg:grid lg:grid-cols-5" id="footer">
      <div className="relative mb-16 block h-32 lg:col-span-2 lg:h-full">
        <Image alt="logo" className="mx-auto w-3/4 brightness-75 filter" placeholder="blur" src={logo} />
      </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <Link className="text-gray-700 transition hover:opacity-75" href="#info">
                    Contact Us
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <Link className="text-gray-700 transition hover:opacity-75" href="#faq">
                    FAQs
                  </Link>
                </li>
                <li>
                  <Link className="text-gray-700 transition hover:opacity-75" href="#team">
                    Meet the Team
                  </Link>
                </li>
                <li>
                  <Link className="text-gray-700 transition hover:opacity-75" href="#schedule">
                    Schedule
                  </Link>
                </li>
                <li>
                  <Link className="text-gray-700 transition hover:opacity-75" href="#sponsors">
                    Sponsors
                  </Link>
                </li>
              </ul>
